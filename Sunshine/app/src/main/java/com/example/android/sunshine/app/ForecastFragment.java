...
public class ForecastFragment extends Fragment {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            String responseUnit = "metric";
            int responseNumDays = 7;
            String[] wheatherForecast = null;
            try {
                ...
                wheatherForecast = getWeatherDataFromJson(forecastJsonStr, responseNumDays);
            } catch (IOException e) {
